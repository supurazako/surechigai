...
ブラウザで http://localhost:8000/ を開いておくと、広場ページが3秒ごと自動更新されます。ページ上部のフォームへ端末名と完成した文章を入力すると、BLE端末を使わず手動でも画像生成を開始できます。Apple Siliconローカルモードでは、送信した文章をMac内のモデルで処理し、完成画像を同じページに表示します。
